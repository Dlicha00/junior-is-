...
\section{Methodology}
In this section, I will explain how the stock scoring engine turns raw financial and qualitative inputs into a ranked output. I will describe the scope of the system, the data pipeline, the scoring process, and the interface decisions that make the results interpretable to users.
