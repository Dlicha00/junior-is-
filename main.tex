...
\section{Results}
In this section, I will report the outputs produced by the scoring engine and explain how I will judge whether the system is working as intended. Rather then claiming guaranteed investment performance, I will focus on whether the system produces transparent, consistent, and useful rankings from the chosen inputs.
